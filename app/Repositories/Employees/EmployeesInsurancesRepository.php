...
class EmployeesInsurancesRepository implements CategoryRepositoryInterface
{
    use DataTypeTrait;
    use CategoryUITrait;
    ...
    public $table_model = EmployeesInsurance::class;
    public $data;
    ...
    public function __construct()
    {
        ...
        $this->data['position']['option'] = $this->data_option['employees_insurances']['position'];
    }
