...
<header class="header content-wrapper">
    ...
    <div>
        ...
        @else
            <div class="auth-button {{$class_header_color}}" onclick="functionsArray['open_modal']('auth', {})">Увійти</div>
        @endif
        ...
        <div class="burger" onclick="functionsArray['add_class'](this, 'modal_wrapper_two', 'open')">
                <svg width="25" height="25" viewBox="0 0 42 26" fill="{{$class_header_color}}" xmlns="http://www.w3.org/2000/svg">
                    <path
